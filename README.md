...
7. 只驗「有沒有推出去」不夠。**推出去了 ≠ 合進 main ≠ 本地跟上**：PR 合了但本地沒拉、而且本地還卡著一個推不上去的舊 commit（遠端已有 squash 版），`git pull` 會直接失敗。`--verify-only` 現在三層都驗
8. 驗收只管捲版相關的 commit。第一版把小說 repo 裡 9 個創作 commit 報成「未推」，那不是這支工具的事——製造雜訊會讓人不看輸出
